...
-- Tiempo de generación: 24-11-2023 a las 10:14:57
...
--
-- Base de datos: `partial_2023_mysql`
--
...
CREATE TABLE IF NOT EXISTS `dml_2023` (
  ...
  `conjuntos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `operations` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE DEFINER=`root`@`localhost` EVENT `config_event` ON SCHEDULE EVERY 1 MINUTE STARTS '2023-11-24 14:22:00' ENDS '2023-11-24 16:00:00' ON COMPLETION PRESERVE DISABLE DO CALL logs()$$

DROP EVENT IF EXISTS `generate`$$
CREATE DEFINER=`root`@`localhost` EVENT `generate` ON SCHEDULE AT '2023-11-24 14:22:00' ON COMPLETION PRESERVE DISABLE DO CALL generateTables()$$
